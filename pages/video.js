class Video extends Page{
	...
	styles(){
		return[
			...
			'ᝰ>[cc="website"]>[T="V"]>div{display:flex;border-radius:0 0 4px 4px;background:rgba(180,180,180,.3)}',
			'ᝰ>[cc="website"]>[T="V"]>div>*{flex:1;line-height:30px;text-align:left;padding:0 .3rem}',
