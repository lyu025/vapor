...
<app>
	<header>${'menu'.V('toggle_menu')}<div id='ptitle'></div>${'download'.V('install_app',{c:'hide',id:'install_app'})}${'clean'.V('clear_cache')}${`proxy_${this.use_proxy?'on':'off'}`.V('toggle_proxy',{id:'toggle_proxy'})}${'theme'.V('toggle_theme')}</header>
